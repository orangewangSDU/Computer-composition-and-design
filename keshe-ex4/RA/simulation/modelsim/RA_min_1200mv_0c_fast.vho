...
-- RA	=>  Location: PIN_31,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- W2	=>  Location: PIN_43,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- T4	=>  Location: PIN_50,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF RA IS
...
-- Equation(s):
-- \inst~1_combout\ = (\W2~input_o\ & ((\inst~0_combout\) # ((\MOV3~input_o\ & \T4~input_o\))))
