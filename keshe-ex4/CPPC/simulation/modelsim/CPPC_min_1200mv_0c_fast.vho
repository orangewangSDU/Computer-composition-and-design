...
-- CPPC	=>  Location: PIN_34,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- T3	=>  Location: PIN_33,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF CPPC IS
...
SIGNAL \CPPC~output_o\ : std_logic;
...
-- Equation(s):
-- \inst2~0_combout\ = (\W2~input_o\ & ((\MOV3~input_o\) # ((\MOV2~input_o\) # (\MOV1~input_o\))))
...
-- Equation(s):
-- \inst2~1_combout\ = (\T3~input_o\ & ((\W1~input_o\) # ((\T2~input_o\ & \inst2~0_combout\)))) # (!\T3~input_o\ & (\T2~input_o\ & ((\inst2~0_combout\))))
