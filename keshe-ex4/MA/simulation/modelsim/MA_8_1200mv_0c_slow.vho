...
-- MA	=>  Location: PIN_34,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF MA IS
...
-- Equation(s):
-- \inst3~0_combout\ = (\W2~input_o\ & ((\MOV3~input_o\) # ((\MOV2~input_o\) # (\MOV1~input_o\))))
...
-- Equation(s):
-- \inst3~1_combout\ = (\T2~input_o\ & ((\W1~input_o\) # ((\T3~input_o\ & \inst3~0_combout\)))) # (!\T2~input_o\ & (\T3~input_o\ & ((\inst3~0_combout\))))
